...
def build_parser():
    parser = argparse.ArgumentParser(
        description='silitop: Performance monitoring CLI tool for Apple Silicon')
...
def main():
    ...
    print("\nSILITOP - Performance monitoring CLI tool for Apple Silicon")
    print("You can update SILITOP by reinstalling the latest package build")
    print("Forked from `asitop`")
    print("P.S. You are recommended to run SILITOP with `sudo silitop`\n")
    print("\n[1/3] Loading SILITOP\n")
    print("\033[?25l")
